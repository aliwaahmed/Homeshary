...
public class Adapter_relateed  extends RecyclerView.Adapter<viewholder_saller>{
    ...
    public  Adapter_relateed (videoscallback videoscallback ,ArrayList<apidata> related, Context mContext) {
    ...
    @NonNull
    @Override
    public viewholder_saller onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {


        return new viewholder_saller(
                LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.display_videos_raw, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull viewholder_saller holder, int position) {
        ...
        holder.dis_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                videoscallback.video_clicked_related(related.get(position).getVideo_link(),position);
            }
        });
...
class  viewholder_saller extends RecyclerView.ViewHolder
{

    public ImageView dis_image;
    public TextView dis_title,dis_channel_name,dis_numViews;
    public viewholder_saller(@NonNull View itemView) {
        super(itemView);
