...
import com.customer.shary.live.ui.home.Adapters.VideoPlayerViewHolder;
...
public class VideoPlayerRecyclerView extends RecyclerView {
    ...
    // ui
    private ImageView thumbnail, media;
            ...
            public void onPlayerStateChanged(boolean playWhenReady, int playbackState) {
                switch (playbackState) {
                    ...
                    case Player.STATE_ENDED:
                        ...
                        //TODO :Auto Scrolling
                        // ScrollingActivity.mRecyclerView.smoothScrollToPosition(targetPosition+1);
                        media.setVisibility(VISIBLE);
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        if (mediaUrl != null) {
            ...
            Log.e("urladapter", mediaUrl.toString());
            releasePlayer();
            init(getContext());
